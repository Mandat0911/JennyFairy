	...
	return (
		<motion.div
				...
				{!isSubmitted ? (
					<form onSubmit={handleSubmit}>
						...
						<motion.button
							...
							whileTap={{ scale: 0.98 }}
							className=' w-full py-3 px-4 bg-gradient-to-r from-pink-300 to-rose-400 text-white font-bold rounded-lg
			...
			<div className='px-8 py-4 bg-gray-900/50 flex justify-center'>
				<Link to={"/login"} className='text-sm text-pink-500 hover:underline flex items-center'>
